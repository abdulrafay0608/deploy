...
const SignupPage = () => {
  ...
  return (
    <Fragment>
      <MetaData title={"Create Account - Ecommerce"} />
      <div className="h-[100vh] flex flex-col justify-center gap-6 items-center w-full my-5">
        <div className="w-[430px]">
          ...
          <form className="w-full" onSubmit={registerSubmit}>
            ...
            <div className="text-gray-500 my-5 flex justify-center items-center gap-2 border border-black p-3 w-full">
          ...
          <div className="my-5 text-sm">
            You have Already Create Account?{" "}
            <Link to={"/account/login"} className="text-orange-500 font-bold">
              Login.
            </Link>
          </div>
        </div>
